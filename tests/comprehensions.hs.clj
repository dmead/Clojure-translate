...
lbinds (gensym "b1")  ]
    (cond 
 (matches b0 ) (eval (applyBinds b0`(flatmap (list (fn [x]((cons  (* x x)) ())) l )))) 
...
lbinds (gensym "b1")  ]
    (cond 
 (matches b0 ) (eval (applyBinds b0`())) 
 (matches b1 ) (eval (applyBinds b1`(++ (qs (flatmap (list (fn [x](if (<= x h)((cons  x) ())())) t ))) (cons  h (qs (flatmap (list (fn [x](if (> x h)((cons  x) ())())) t ))))))) 
